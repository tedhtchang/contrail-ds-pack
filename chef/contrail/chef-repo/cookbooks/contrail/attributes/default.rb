...
default['contrail']['cfgm']['hostname'] = "#{node['contrail']['network_fqdn']}"
...
# Compute
default['contrail']['compute']['interface'] = "#{node['contrail']['compute_node_interface']}"
...
default['contrail']['compute']['domain'] = "hipods.svl.ibm.com"
